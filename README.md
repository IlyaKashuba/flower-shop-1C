...
![Форма документа Продажа](docs/images/номенклатура.png)

### Документ "Продажа"
![Форма документа Продажа](docs/images/продажа_товаров.png)

### Документ "Сборка букета"
![Форма документа Продажа](docs/images/сборка_букета.png)

### Документ "Приходная накладная"
![Форма документа Продажа](docs/images/приходная_накладная.png)

### Отчёт "Выручка по товарам"
![Отчёт ВыручкаПоКассирам](docs/images/отчет_выручка_по_товарам.png)

### Справочник "Номенклатура"
![Справочник Номенклатура](docs/images/nomenclature.png)
