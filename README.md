# 🌸 Цветочный магазин — Учебная конфигурация на 1С:Предприятие 8.3

Учебный проект для отработки навыков проектирования и разработки на платформе 1С:Предприятие 8.3.  
...
## Стек и инструменты
- **Платформа:** 1С:Предприятие 8.5 (Управляемые формы)
